...
/// @param success Successful callback (成功回调)
/// @param failure failure callback (失败回调)
- (void)getTuyaSceneListSuccess:(MeariSuccess_Dictionary)success failure:(MeariFailure)failure;
...
/// @param success Successful callback (成功回调)
/// @param failure failure callback (失败回调)
- (void)customizeTuyaSceneWithSceneJson:(NSString *)sceneJson isUpdate:(BOOL)isUpdate success:(MeariSuccess)success failure:(MeariFailure)failure;
...
获取用户配网产品列表
*/
- (void)getProductList:(void(^)(NSDictionary *dic)) success failure:(MeariFailure)failure;
/**
Get User product
获取配网产品图片
 @param kindType 类型
 ...
 */
-(void)setUserTimeType:(NSString *)timeType success:(void(^)(NSDictionary *dic))success failure:(MeariFailure)failure;

/**
Get User Preference
获取用户偏好设置信息
*/
-(void)getUserPreference:(void(^)(NSDictionary *dic))success failure:(MeariFailure)failure;

/**
Set User PushRingSwitch
设置用户来电铃响开关
*/
-(void)setUserPushRingSwitch:(BOOL)pushRingSwitch success:(void(^)(NSDictionary *dic))success failure:(MeariFailure)failure;
@end
